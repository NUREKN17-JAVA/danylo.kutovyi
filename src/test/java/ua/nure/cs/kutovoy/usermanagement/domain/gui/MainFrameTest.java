package ua.nure.cs.kutovoy.usermanagement.domain.gui;
...
import ua.nure.cs.kutovoy.usermanagement.domain.User;
import ua.nure.cs.kutovoy.usermanagement.domain.db.DaoFactory;
import ua.nure.cs.kutovoy.usermanagement.domain.db.DaoFactoryImpl;
import ua.nure.cs.kutovoy.usermanagement.domain.db.MockDaoFactory;
import ua.nure.cs.kutovoy.usermanagement.domain.db.MockUserDao;
...
public class MainFrameTest extends JFCTestCase {
	...
	protected void setUp() throws Exception {
			...
			try {
				...
				//properties.setProperty("ua.nure.cs.kutovoy.usermanagement.domain.db.UserDao",
